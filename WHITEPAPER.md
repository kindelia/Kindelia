...
This is an extensive paper with a lot of information. To learn how Kindelia
compares to other p2p computers, move on to the [next
section](#comparisons-to-ethereum). If you'd prefer to see some examples, skip
to the [Examples](#examples). If you'd rather read a long list of specs, head on
to the [Technical Overview](#technical-overview). Finally, in the end of this
paper we write some opinionated articles on the state of blockchain projects and
the why's behind Kindelia's existence and design choices; click [here](#notes)
to jump to it.
